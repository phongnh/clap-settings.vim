function! clap#themes#solarized#init() abort
    if &background == 'dark'
        let s:palette = {
                    ...
                    \ 'current_selection':      { 'guifg': '#93a1a1', 'ctermfg': '109', 'guibg': '#073642', 'ctermbg': '23', 'gui': 'bold', 'cterm': 'bold' },
        ...
        let s:palette = {
                    ...
                    \ 'current_selection':      { 'guifg': '#586e75', 'ctermfg': '60',  'guibg': '#eee8d5', 'ctermbg': '224', 'gui': 'bold', 'cterm': 'bold' },
